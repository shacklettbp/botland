...
#define REQ_SLANG(expr) \
    ::bot::gas::checkSlang((expr), __FILE__, __LINE__,\
...
{
#define CASE_STR(e) case e: return BOT_STRINGIFY(e)
...
GAS_SHADER_COMPILER_VIS ::bot::gas::ShaderCompiler * gasCreateShaderCompiler()
{
  return ::bot::gas::CompilerBackend::init();
}

GAS_SHADER_COMPILER_VIS void
    gasDestroyShaderCompiler(::bot::gas::ShaderCompiler *shaderc)
{
  delete shaderc;
}
