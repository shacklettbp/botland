...
struct CompiledShadersBlob {
  ...
  bool load(StackAlloc &alloc, const char *path);
...
enum class CommandCtrl : u32 {
  ...
  DrawDataBuffer         = 1 << 7,
  DrawDataOffset         = 1 << 8,
  DrawVertexBuffer0      = 1 << 9,
  DrawVertexBuffer1      = 1 << 10,
  DrawIndexBuffer32      = 1 << 11,
  DrawIndexBuffer16      = 1 << 12,
  DrawIndexOffset        = 1 << 13,
  DrawNumTriangles       = 1 << 14,
  DrawVertexOffset       = 1 << 15,
  DrawInstanceOffset     = 1 << 16,
  DrawNumInstances       = 1 << 17,
